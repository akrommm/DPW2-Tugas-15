                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <div class="product-details-action">
                                        <a href="{{ url('cart', $produk->id) }}" class="btn-product btn-cart"><span>Tambah Keranjang</span></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 justify-content-end">
                    ...
                    <a href="{{ url('checkout')}}" class="btn btn-outline-primary-2 btn-order btn-block">CHECKOUT</a>
                </div><!-- End .col-6 -->
            </div><!-- End .row -->
        </div><!-- End .container -->
    </div><!-- End .sticky-bar -->
